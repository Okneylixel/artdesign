...
var calc = function calc(size, material, options, promocode, result) {
  ...
  var calcFuun = function calcFuun() {
  ...
  sizeBlock.addEventListener('change', calcFuun);
  materialBlock.addEventListener('change', calcFuun);
  optionsBlock.addEventListener('change', calcFuun);
  promocodeBlock.addEventListener('input', calcFuun);
};
...
var drop = function drop() {
  //drag *
  //dragend *
  //dragenter - обект над dropArea
  //dragleave - обект за пределами dropArea
  //dragexit *
  //dragover - обeкт зависает над dropArea
  //dragstart *
  //drop - обект отправлен в dropArea
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      statusImg.classList.add('animater', 'fadeInUp');
      statusMessage.appendChild(statusImg);
      var textMassage = document.createElement('div');
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_6__["postData"])(api, formData).then(function (res) {
        ...
        textMassage.textContent = message.success;
      }).catch(function () {
